...
const api = {
  ...
  rinneLegacy: {
    getStatus: () => ipcRenderer.invoke("rinne-legacy:status"),
    loadCatalog: () => ipcRenderer.invoke("rinne-legacy:load-catalog"),
    loadPortrait: (portraitId: number) =>
      ipcRenderer.invoke("rinne-legacy:load-portrait", portraitId),
    loadOverlay: (overlayId: string) =>
      ipcRenderer.invoke("rinne-legacy:load-overlay", overlayId),
    loadCustomOutfit: () =>
      ipcRenderer.invoke("rinne-legacy:load-custom-outfit"),
    refresh: (emotion?: string) =>
      ipcRenderer.invoke("rinne-legacy:refresh", emotion),
  },
};
