...
interface ChatHistoryState {
  ...
  appendHumanMessage: (content: string, attachments?: Message['attachments']) => void;
...
export function ChatHistoryProvider({ children }: { children: React.ReactNode }) {
   ...
   */
  const appendHumanMessage = useCallback((content: string, attachments?: Message['attachments']) => {
